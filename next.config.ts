...
const securityHeaders = [
  ...
  // Allows: own origin, Stripe.js, Google Pay, Apple Pay
  {
    ...
    value: [
      "default-src 'self'",
      // Scripts: own + Stripe + Google Pay + Cloudflare Turnstile
      "script-src 'self' 'unsafe-inline' https://js.stripe.com https://pay.google.com https://challenges.cloudflare.com",
