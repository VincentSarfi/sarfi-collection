...
export const alt = "Haus Schönblick – Panorama-Apartments im Bayerischen Wald";
  ...
  return new ImageResponse(
    (
      ...
      >
        ...
        <div style={{ display: "flex", fontFamily: "Cormorant Garamond", fontSize: 92, color: "#fdfaf5", marginTop: 20 }}>
          Haus Schönblick
        </div>
        <div style={{ display: "flex", fontFamily: "DM Sans", fontSize: 32, color: "#fdfaf5", opacity: 0.82, marginTop: 10, textAlign: "center" }}>
          5 Panorama-Apartments im Bayerischen Wald
        </div>
