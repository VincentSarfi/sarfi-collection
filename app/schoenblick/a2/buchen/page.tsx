...
export const metadata: Metadata = {
  title: "Apartment A2 buchen – Haus Schönblick",
  description:
    "Buche Apartment A2 im Haus Schönblick direkt. Panorama-Apartment im Bayerischen Wald. Ohne Plattformgebühren.",
  robots: { index: false },
}

export default function A2BuchenPage() {
        ...
        <div className="container-site py-5 flex flex-wrap items-center justify-between gap-3">
          <div>
            ...
            <h1 className="font-display text-2xl text-cream-50">
              Apartment A2 <span className="text-gold-300">buchen</span>
            </h1>
          </div>
          {apt && (
