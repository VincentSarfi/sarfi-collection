  ...
  },
  {
    ...
    a: (
      <>
        ...
        <Link href="/stornierung" className="text-gold-600 underline underline-offset-2">
          sarfi-collection.de/stornierung
        </Link>
        .
      </>
    ),
            ...
            <div>
              ...
              <div className="space-y-4">
                ...
                >
                  ...
                  <div>
                    <p className="font-body text-xs text-forest-400 mb-0.5">Telefon</p>
                    <p className="font-body text-sm font-medium text-forest-800 group-hover:text-gold-700 transition-colors">
                      +49 176 56850146
                    </p>
                  </div>
                ...
                >
                  ...
                  <div>
                    <p className="font-body text-xs text-forest-400 mb-0.5">WhatsApp</p>
                    <p className="font-body text-sm font-medium text-forest-800 group-hover:text-gold-700 transition-colors">
                      Nachricht schreiben
                    </p>
                  </div>
