...
const jsonLd = {
  ...
  "@type": "VacationRental",
  "@id": "https://www.sarfi-collection.de/schoenblick/b5",
  ...
  url: "https://www.sarfi-collection.de/schoenblick/b5",
...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    { "@type": "ListItem", position: 3, name: apt.name, item: "https://www.sarfi-collection.de/schoenblick/b5" },
  ],
};
