          ...
          <div className="flex flex-col sm:flex-row items-center justify-center divide-y sm:divide-y-0 sm:divide-x divide-cream-50/10">
            ...
            <div className="flex flex-col items-center gap-2 text-center px-10 pb-8 sm:pb-0">
              ...
              <div className="flex items-center gap-1 mb-1">
                ...
                <img src="/images/awards/laurel-left.svg" alt="" className="h-20 w-auto object-contain" />
                <span className="font-body font-black text-5xl text-cream-50 mx-2 tracking-tight">5,0</span>
                {/* eslint-disable-next-line @next/next/no-img-element */}
                <img src="/images/awards/laurel-right.svg" alt="" className="h-20 w-auto object-contain" />
              </div>
