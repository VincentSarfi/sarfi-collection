...
export const metadata: Metadata = {
  ...
  alternates: alternatesFor("/schoenblick/a2", "en"),
};

const jsonLd = {
  "@context": "https://schema.org",
  "@type": "VacationRental",
  "@id": "https://www.sarfi-collection.de/en/schoenblick/a2",
  ...
  url: "https://www.sarfi-collection.de/en/schoenblick/a2",
...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    { "@type": "ListItem", position: 3, name: apt.name, item: "https://www.sarfi-collection.de/en/schoenblick/a2" },
  ],
};
