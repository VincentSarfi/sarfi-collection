...
const jsonLd = {
  ...
  "@type": "VacationRental",
  "@id": "https://www.sarfi-collection.de/en/schoenblick/b8",
...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    { "@type": "ListItem", position: 3, name: apt.name, item: "https://www.sarfi-collection.de/en/schoenblick/b8" },
  ],
};

export default function EnglishB8Page() {
  return (
    <>
