...
export const metadata: Metadata = {
  ...
  alternates: alternatesFor("/schoenblick/b5", "en"),
};

const jsonLd = {
  "@context": "https://schema.org",
  "@type": "VacationRental",
  "@id": "https://www.sarfi-collection.de/en/schoenblick/b5",
  identifier: "b5-schoenblick-sarfi-collection",
  ...
  url: "https://www.sarfi-collection.de/en/schoenblick/b5",
...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    { "@type": "ListItem", position: 3, name: apt.name, item: "https://www.sarfi-collection.de/en/schoenblick/b5" },
  ],
};

export default function EnglishB5Page() {
  return (
    <>
