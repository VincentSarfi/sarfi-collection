...
const config = PROPERTY_CONFIGS.b6;
...
export const metadata: Metadata = {
  ...
  alternates: alternatesFor("/schoenblick/b6", "en"),
};

const jsonLd = {
  "@context": "https://schema.org",
  "@type": "VacationRental",
  "@id": "https://www.sarfi-collection.de/en/schoenblick/b6",
  ...
  url: "https://www.sarfi-collection.de/en/schoenblick/b6",
...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    { "@type": "ListItem", position: 3, name: apt.name, item: "https://www.sarfi-collection.de/en/schoenblick/b6" },
  ],
};

export default function EnglishB6Page() {
  return (
    <>
