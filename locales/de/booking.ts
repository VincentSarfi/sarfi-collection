...
const booking = {
  ...
  form: {
    ...
    legalSidebar: {
      ...
      post: ". Infos zur Datenverarbeitung: ",
      privacy: "Datenschutzerklärung",
      end: ".",
    },
    legalFull: {
      pre: "Mit Klick auf den Zahlen-Button gibst du eine zahlungspflichtige Buchung ab und akzeptierst unsere ",
      terms: "AGB",
      mid: " inkl. ",
      cancellation: "Stornierungsbedingungen",
      post: ". Infos zur Verarbeitung deiner Daten findest du in der ",
      privacy: "Datenschutzerklärung",
      end: ". Deine Daten werden ausschließlich zur Buchungsabwicklung verwendet.",
    },
  ...
  payment: {
    ...
    // Welche Zahlarten erscheinen, steuert das Stripe-Dashboard (automatic_payment_methods)
