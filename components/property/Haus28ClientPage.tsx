...
// Bilder der Schlafzimmer-Karten; Namen & Betten kommen aus dem Dictionary.
const bedroomImgs = [
  "/images/haus28/gallery/haus_28_250523_604.webp",
  "/images/haus28/gallery/haus_28_250523_647.webp",
  "/images/haus28/gallery/haus_28_250523_380.webp",
  "/images/haus28/gallery/haus_28_250523_413.webp",
]
...
export default function Haus28ClientPage() {
  ...
  const averageRatingLabel = `${reviewStats.ratingValue.toFixed(2).replace(".", t.listing.decimal)} ★`
  const bedrooms = t.haus28.bedroomsList.map((room, i) => ({ ...room, img: bedroomImgs[i] }))
  ...
  const slides = haus.images.gallery.map((img) => ({ src: img.src, alt: img.alt }))
  const mainImg = haus.images.gallery[0]
  const secondaryImgs = haus.images.gallery.slice(1, 5)
  ...
  const related = Object.values(schoenblickLocalized.apartments ?? {})
    ...
    .map((apt) => ({
      ...
      bookHref: localizeHref(`/schoenblick/${apt.id}`, locale),
      ...
      <article className="pt-16 md:pt-20 bg-cream-50">
        ...
        <div className="md:hidden relative mb-6">
          ...
          <div className="absolute bottom-4 right-4 px-2.5 py-1 bg-black/60 rounded-full font-body text-xs text-white pointer-events-none">
            {mobilePhotoIndex + 1} / {haus.images.gallery.length}
          </div>
          {/* Alle Fotos (mobil) */}
          <button
          ...
          >
            <IconExpand size={12} />
            {t.listing.allPhotosPre}{haus.images.gallery.length}{t.listing.allPhotosPost}
          </button>
        </div>
            ...
            <div className="min-w-0">
              ...
              <div className="pb-6 border-b border-cream-200">
                ...
                <p className="font-body text-sm text-forest-500 mb-3">
                  {haus.maxGuests} {t.listing.guestsWord} · {haus.bedrooms} {t.listing.bedroomsWord} · {haus.bedrooms} {t.listing.bedsWord} · {haus.bathrooms} {haus.bathrooms === 1 ? t.listing.bathroomWord : t.listing.bathroomsWord}
                </p>
                ...
                <div className="flex flex-wrap items-center gap-x-2.5 gap-y-1 font-body text-sm text-forest-700">
                  ...
                  {haus.guestFavorite && (
                    <>
                      <span className="flex items-center gap-1.5">
                        ...
                        <span className="font-semibold">{t.haus28.guestFavorite}</span>
                      </span>
                      <span className="text-forest-300">·</span>
                    </>
                  )}
                  ...
                  >
                    {totalReviews}{t.listing.reviewsPost}
                  </a>
                  <span className="text-forest-300">·</span>
              ...
              {/* Amenities */}
              <div className="py-6 border-b border-cream-200">
                <h2 className="font-display text-xl text-forest-900 mb-5">{t.haus28.amenitiesHeading}</h2>
                ...
                <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                  <div>
                    ...
                    <h2 className="font-display text-xl text-forest-900 mb-1">
                      {t.haus28.excursions.heading}
                    </h2>
                    <p className="font-body text-sm text-forest-600 max-w-lg">
                      {t.haus28.excursions.text}
                    </p>
                  </div>
                  <Link
                    href={localizeHref("/ausflugsziele#buechelstein-wanderung", locale)}
            ...
            <div className="flex flex-col sm:flex-row gap-8 items-start">
                ...
                <div className="flex items-center gap-4 mb-5">
                  ...
                  <div>
                    ...
                    <div className="flex items-center gap-1 mt-0.5">
                      ...
                      <span className="font-body text-xs text-forest-500">{t.listing.superhost}</span>
                    </div>
                  </div>
                </div>
              ...
              <div className="flex-1 space-y-5">
                <p className="font-body text-base text-forest-700 leading-relaxed">
                  {t.haus28.hostProfile.bio}
                </p>
                <div className="rounded-xl border border-cream-200 bg-cream-50 p-5 space-y-3">
                  <div>
                    <p className="font-body text-sm font-semibold text-forest-900 mb-0.5">{t.haus28.hostProfile.superhostTitle}</p>
                    <p className="font-body text-sm text-forest-600">
                      {t.haus28.hostProfile.superhostText}
                    </p>
                  </div>
                  <div className="pt-3 border-t border-cream-200 space-y-1">
                    <p className="font-body text-sm text-forest-700">
                      <span className="font-semibold">{t.haus28.hostProfile.responseRateLabel}</span>{t.haus28.hostProfile.responseRateValue}
                    </p>
                    <p className="font-body text-sm text-forest-700">
                      {t.haus28.hostProfile.respondsWithin}
                    </p>
                  </div>
                </div>
                <Link
                ...
                >
                  {t.haus28.hostProfile.messageHost}
                </Link>
              </div>
            </div>
          </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-6">
              ...
              <div>
                ...
                <ul className="space-y-1.5 font-body text-sm text-forest-600">
                  ...
                  <li>{t.haus28.ruleCheckOut}</li>
                  <li>{t.listing.ruleMaxGuestsPre}{haus.maxGuests}{t.listing.ruleMaxGuestsPost}</li>
                  <li>{t.haus28.ruleNoPets}</li>
              ...
              <div>
                <div className="flex items-center gap-2.5 mb-3">
                  ...
                  <p className="font-body text-sm font-semibold text-forest-900">{t.haus28.cancellationTitle}</p>
                </div>
              ...
              <div>
                <div className="flex items-center gap-2.5 mb-3">
                  ...
                  <p className="font-body text-sm font-semibold text-forest-900">{t.haus28.safetyTitle}</p>
                </div>
                <ul className="space-y-1.5 font-body text-sm text-forest-600">
                  {t.haus28.safetyItems.map((item) => (
                    <li key={item}>{item}</li>
                  ))}
                </ul>
              </div>
          ...
          <div>
            ...
            {haus.airbnbRating > 0 && (
              <div className="flex items-center gap-1 mt-0.5">
                ...
                <span className="font-body text-xs font-semibold text-forest-700">{haus.airbnbRating}</span>
              </div>
            )}
          </div>
          <button
          ...
          {showMobileBooking && (
            ...
            >
              <div className="sticky top-0 z-10 bg-white border-b border-cream-200 px-4 py-3 flex items-center justify-between">
                ...
                <p className="font-body text-sm font-semibold text-forest-900">{haus.name}</p>
                <div className="w-9" />
              </div>
              <BookingWidget
                smoobuId={smoobuId}
      ...
      <AnimatePresence>
        {galleryOpen && (
          <motion.div
            ...
            role="dialog"
            aria-modal="true"
            aria-label={`${t.listing.allPhotosPre}${haus.images.gallery.length}${t.listing.allPhotosPost}`}
          >
            {/* Sticky Header */}
            <div className="sticky top-0 z-10 flex items-center justify-between px-4 md:px-8 py-4 bg-cream-50/90 backdrop-blur-sm border-b border-cream-200">
              ...
              <span className="font-body text-sm text-forest-500">
                {haus.images.gallery.length}{t.listing.photosPost}
              </span>
            </div>
